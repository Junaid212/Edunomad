...
export default function OnlineTutorReg({ isDarkMode ,toggleDarkMode, isMobileMenuOpen, toggleMobileMenu }) {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className={`rounded-2xl shadow-xl border p-8 ${
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold mb-2">Online Tutor Registration</h1>
