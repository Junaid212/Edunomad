// src/components/AddJobVacancy.jsx
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 px-6 py-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                {/* Department */}
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#D1D136]"
                  />
                </div>
                {/* Job Type */}
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    required
                    className="mt-1 w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#DAD024]"
                  >
            ...
            <section className="space-y-4">
              <h3 className="text-lg font-semibold text-[#DAD024]">Job Description & Details</h3>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white py-3 rounded-xl hover:bg-blue-700 disabled:opacity-50 transition"
            >
              {isLoading
                ? 'Posting Job…'
                : <>
